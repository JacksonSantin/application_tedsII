              ...
              <tbody>
                <?php foreach($lista as $item):?>
                  <tr>
                    ...
                    <td><?= $item['user_cad']; ?></td>
                    <td>
                        <a class="btn btn-xs btn-info" href="<?= site_url('salary/cadastrar/'.$item['id']); ?>">
                            <i class="fa fa-fw fa-edit"></i>
                        </a>
                        <a class="btn btn-xs btn-danger confirmaExclusao" data-id="<?= $item['id'];?>" data-nome="<?= $item['salary'];?>">
...
<script type="text/javascript">
  $('.confirmaExclusao').on('click', function(e){
    e.preventDefault();
    var id = $(this).data('id');
    var nome = $(this).data('salary');

    console.log('id: ' + id,'salary: ' + nome);
  ...
  function remove(){
    ...
    document.location.href = "<?= site_url('salary/remover/') ?>" + id;
  }
</script>
